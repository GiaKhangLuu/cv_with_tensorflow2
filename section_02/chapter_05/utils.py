...
# ===========================Dataset utils==========================
@tf.function
def transfrom_targets_for_output(y_true, grid_size, anchor_idxs, classes):
...
def transform_targets(y_train, anchors, anchor_masks, classes):
    ...
    for anchor_idxs in anchor_masks:
        y_outs.append(transfrom_targets_for_output(y_train, grid_size,
                                                  anchor_idxs, classes))
        grid_size *= 2
